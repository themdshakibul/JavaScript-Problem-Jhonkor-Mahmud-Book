...
if (eage > 12 || hen === false) {
  console.log("Tui dim komra ranna korbi");
} else {
  console.log("paruti ar kola khabi");
}
...
let tempurater = 101
let hasCough = false // nai 


if (tempurater > 100 || hasCough === true) {
    console.log("Docktor ar kache jabe")
}else{
    console.log("katah mure diye suye tahkbe")
}
